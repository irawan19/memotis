					...
					<div class="card-body">
						...
						<div class="form-group">
				            ...
				            <select class="form-control select2" id="level_sistems_id" name="level_sistems_id">
				            	...
				            	@foreach($edit_sub_level_sistems as $level_sistems)
				                  	@php($selected = '')
					              	@if(Request::old('level_sistems_id') == '')
					              		@if($level_sistems->id_level_sistems == $edit_level_sistems->level_sistems_id)
				            ...
				            <select class="form-control select2" id="divisis_id" name="divisis_id">
				            	...
				            	@foreach($edit_divisis as $divisis)
					              	...
					              	@else
					              		...
					              		@endif
					              	@endif
								    <option value="{{$divisis->id_divisis}}" {{ $selected }}>{{$divisis->nama_divisis}}</option>
				            	@endforeach
				            </select>
		                </div>
						<hr/>
