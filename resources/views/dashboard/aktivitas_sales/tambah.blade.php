								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<input class="form-control right-align priceformat {{ General::validForm($errors->first('room_revenue')) }}" id="room_revenue" type="text" name="room_revenue" value="{{ Request::old('room_revenue') !== null && Request::old('room_revenue') !== '' ? Request::old('room_revenue') : General::ubahDBKeHarga(0) }}">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input class="form-control right-align priceformat {{ General::validForm($errors->first('banquet_revenue')) }}" id="banquet_revenue" type="text" name="banquet_revenue" value="{{ Request::old('banquet_revenue') !== null && Request::old('banquet_revenue') !== '' ? Request::old('banquet_revenue') : General::ubahDBKeHarga(0) }}">
